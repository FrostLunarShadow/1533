...
UUID=${UUID:-'e7c69cf5-27d4-4048-a3fb-a7c8618c67a9'}
...
V2-rayN:
----------------------------
vless://${UUID}@104.20.23.145:443?encryption=none&security=tls&sni=\${ARGO_DOMAIN}&type=ws&host=\${ARGO_DOMAIN}&path=%2F${WSPATH}-vless?ed=2048#Argo-Vless
----------------------------
